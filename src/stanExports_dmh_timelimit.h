...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(228, 226, "end", "model_dmh_timelimit");
    return reader;
}
...
decision_l(const int& ar_value,
    ...
    try {
        ...
        if (as_bool(logical_eq(ar_value, 0))) {
            ...
            if (as_bool(logical_eq(terminate, -(1)))) {
                current_statement_begin__ = 12;
                stan::math::assign(prob_d, add(add(elt_multiply(p_n, subtract(1, p_y)), elt_multiply(multiply(.5, p_y), p_n)), elt_multiply(multiply(.5, subtract(1, p_y)), subtract(1, p_n))));
            } else if (as_bool(logical_eq(terminate, 1))) {
                current_statement_begin__ = 15;
                stan::math::assign(prob_d, add(add(elt_multiply(p_y, subtract(1, p_n)), elt_multiply(multiply(.5, p_y), p_n)), elt_multiply(multiply(.5, subtract(1, p_y)), subtract(1, p_n))));
            }
        } else {
            current_statement_begin__ = 18;
            if (as_bool(logical_eq(terminate, -(1)))) {
                current_statement_begin__ = 19;
                stan::math::assign(prob_d, add(p_n, multiply(.5, subtract(subtract(1, p_y), p_n))));
            } else if (as_bool(logical_eq(terminate, 1))) {
                current_statement_begin__ = 22;
                stan::math::assign(prob_d, add(p_y, multiply(.5, subtract(subtract(1, p_y), p_n))));
            }
        }
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(p_end_mu_raw, -(1.2), .3));
            current_statement_begin__ = 107;
            lp_accum__.add(normal_log<propto__>(p_end_s_sd, 0, 0.3));
            if (p_end_s_sd < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
            else lp_accum__.add(-normal_ccdf_log(0, 0, 0.3));
            current_statement_begin__ = 108;
            lp_accum__.add(normal_log<propto__>(p_end_q_sd, 0, 0.3));
            ...
            lp_accum__.add(normal_log<propto__>(sigma_mu_raw, 0, 2));
            current_statement_begin__ = 113;
            lp_accum__.add(normal_log<propto__>(sigma_s_sd, 0, 2));
            if (sigma_s_sd < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
            else lp_accum__.add(-normal_ccdf_log(0, 0, 2));
            current_statement_begin__ = 114;
            lp_accum__.add(normal_log<propto__>(sigma_q_sd, 0, 2));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                if (as_bool(logical_eq(get_base1(terminate, n, "terminate", 1), 0))) {
                    current_statement_begin__ = 146;
                    lp_accum__.add(stan::math::log((1 - get_base1(get_base1(p_end, get_base1(qID, n, "qID", 1), "p_end", 1), get_base1(sID, n, "sID", 1), "p_end", 2))));
                } else {
                    current_statement_begin__ = 148;
                    lp_accum__.add(stan::math::log(get_base1(get_base1(p_end, get_base1(qID, n, "qID", 1), "p_end", 1), get_base1(sID, n, "sID", 1), "p_end", 2)));
                }
            }
            }
        } catch (const std::exception& e) {
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(decision_prob, 
                            ...
                            (stan::model::rvalue(decision_prob, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), "decision_prob") * get_base1(get_base1(p_end, get_base1(qID, n, "qID", 1), "p_end", 1), get_base1(sID, n, "sID", 1), "p_end", 2)), 
                            "assigning variable decision_prob");
                current_statement_begin__ = 221;
                stan::model::assign(decision_prob, 
                            stan::model::cons_list(stan::model::index_uni(2), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), 
                            (1 - get_base1(get_base1(p_end, get_base1(qID, n, "qID", 1), "p_end", 1), get_base1(sID, n, "sID", 1), "p_end", 2)), 
                            "assigning variable decision_prob");
                current_statement_begin__ = 222;
                stan::model::assign(decision_prob, 
                            stan::model::cons_list(stan::model::index_uni(3), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), 
                            (stan::model::rvalue(decision_prob, stan::model::cons_list(stan::model::index_uni(3), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), "decision_prob") * get_base1(get_base1(p_end, get_base1(qID, n, "qID", 1), "p_end", 1), get_base1(sID, n, "sID", 1), "p_end", 2)), 
                            "assigning variable decision_prob");
