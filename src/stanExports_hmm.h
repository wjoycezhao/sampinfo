...
class model_hmm : public prob_grad {
private:
        double deltaM_value;
        int C;
        int K;
        ...
        std::vector<int> cID;
public:
    model_hmm(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_hmm_namespace::model_hmm";
...
typedef model_hmm_namespace::model_hmm stan_model;
#endif
