...
#include "stanExports_mmdm_timelimit.h"

RCPP_MODULE(stan_fit4mmdm_timelimit_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mmdm_timelimit")
