...
namespace model_hmm_deltas_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hmm_deltas");
    reader.add_event(109, 107, "end", "model_hmm_deltas");
    return reader;
}
#include <stan_meta_header.hpp>
class model_hmm_deltas : public prob_grad {
private:
        double deltaM_value;
        int C;
        int K;
        ...
        std::vector<int> cID;
public:
    model_hmm_deltas(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_hmm_deltas_namespace::model_hmm_deltas";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_hmm_deltas_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_hmm_deltas_namespace::model_hmm_deltas stan_model;
#endif
