...
std::vector<Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T2__, T3__>::type, Eigen::Dynamic, 1> >
decision_l(const T0__& ar_value,
               const int& N,
...
struct decision_l_functor__ {
    template <typename T0__, typename T2__, typename T3__>
        std::vector<Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T2__, T3__>::type, Eigen::Dynamic, 1> >
    operator()(const T0__& ar_value,
               const int& N,
               const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& p_n,
               const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& p_y, std::ostream* pstream__) const {
        return decision_l(ar_value, N, p_n, p_y, pstream__);
    }
};
