...
namespace model_mmdm_timelimit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mmdm_timelimit");
    reader.add_event(289, 287, "end", "model_mmdm_timelimit");
    return reader;
}
...
class model_mmdm_timelimit : public prob_grad {
private:
        int deltaM_value;
        int condition_value;
        int C;
        ...
        int max_tNo_prd;
public:
    model_mmdm_timelimit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mmdm_timelimit_namespace::model_mmdm_timelimit";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mmdm_timelimit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            while (as_bool((primitive_value(logical_eq(terminate_prd, 0)) && primitive_value(logical_lt(tNo_prd, (max_tNo_prd + 1)))))) {
                ...
                stan::math::assign(p_n_prd, (1 - normal_cdf(utility_n_prd, 0, sigma)));
                current_statement_begin__ = 280;
                stan::math::assign(p_y_prd, normal_cdf(utility_y_prd, 0, sigma));
                current_statement_begin__ = 281;
                stan::math::assign(decision_p_prd, decision_l(1, ar_value, to_vector(rep_array(p_n_prd, 1)), to_vector(rep_array(p_y_prd, 1)), to_vector(rep_array(p_end, 1)), pstream__));
...
typedef model_mmdm_timelimit_namespace::model_mmdm_timelimit stan_model;
#endif
