...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mmh");
    reader.add_event(139, 137, "end", "model_mmh");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mmh : public prob_grad {
private:
        double deltaM_value;
        int C;
        int K;
        ...
        std::vector<int> cID;
public:
    model_mmh(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mmh_namespace::model_mmh";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "deltaM_value", "double", context__.to_vec());
            deltaM_value = double(0);
            vals_r__ = context__.vals_r("deltaM_value");
            pos__ = 0;
            deltaM_value = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(deltaM_value, 8))) {
                ...
                for (int q = 1; q <= Q; ++q) {
                    ...
                    stan::model::assign(deltaM, 
                                ...
                                inv_logit(add(add(get_base1(deltaM_mu_raw, 1, "deltaM_mu_raw", 1), multiply(get_base1(deltaM_s_sd, 1, "deltaM_s_sd", 1), deltaM_s_raw)), (get_base1(deltaM_q_sd, 1, "deltaM_q_sd", 1) * get_base1(deltaM_q_raw, q, "deltaM_q_raw", 1)))), 
            ...
            if (as_bool(logical_eq(deltaM_value, 8))) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(deltaM_mu_raw, 1, "deltaM_mu_raw", 1), 0, 2));
                current_statement_begin__ = 83;
                lp_accum__.add(normal_log<propto__>(get_base1(deltaM_s_sd, 1, "deltaM_s_sd", 1), 0, 1));
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(deltaM_q_sd, 1, "deltaM_q_sd", 1), 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mmh_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mmh_namespace::model_mmh stan_model;
#endif
