...
namespace model_mm10d9_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mm10d9");
    reader.add_event(100, 98, "end", "model_mm10d9");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mm10d9 : public prob_grad {
private:
        int C;
        int K;
        int N;
        ...
        std::vector<int> cID;
public:
    model_mm10d9(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mm10d9_namespace::model_mm10d9";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "deltaM", "double", context__.to_vec());
        double deltaM(0);
        deltaM = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, deltaM);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            // model parameters
            current_statement_begin__ = 17;
            local_scalar_t__ deltaM;
            (void) deltaM;  // dummy to suppress unused var warning
            if (jacobian__)
                deltaM = in__.scalar_lb_constrain(0, lp__);
            else
                deltaM = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 18;
            ...
            if (as_bool(logical_gt(K, 0))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    if (as_bool(logical_eq(get_base1(tNo, n, "tNo", 1), 1))) {
                        ...
                        stan::math::assign(X_acc, multiply(X_acc, deltaM));
                    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mm10d9_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double deltaM = in__.scalar_lb_constrain(0);
...
typedef model_mm10d9_namespace::model_mm10d9 stan_model;
#endif
