...
#include "stanExports_mmdm_threshold.h"

RCPP_MODULE(stan_fit4mmdm_threshold_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mmdm_threshold")
